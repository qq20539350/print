...
//    NSLog(@"");
//    BOOL sucess = [myApp.myPos POS_PrintPicture:img x:-1 nWidth:384 nHeight:614 nBinaryAlgorithm:0 nCompressMethod:0];
//    BOOL sucess = [myApp.myPos POS_PrintPicture:img x:-1 nWidth:30 nHeight:60 nBinaryAlgorithm:1 nCompressMethod:1];
