...
- (void)handleConnect:(id)sender
{
    ...
    dispatch_async(myApp.myQueue, ^{
        ...
        if([myApp.myBle Open:peripheral])
        {
            ...
            // 连接成功之后，打印一张测试页。
            [myApp.myPos POS_S_SetBarcode:"NO.20160423" nOrgx:0 nType:0x49 nUnitWidth:2 nHeight:50 nHriFontType:0 nHriFontPosition:2];
            // 注意：upc-a upc-e 等商业条码有格式限制
            [myApp.myPos POS_S_SetBarcode:"20160423111" nOrgx:0 nType:0x41 nUnitWidth:2 nHeight:50 nHriFontType:0 nHriFontPosition:2];
            [myApp.myPos POS_S_SetBarcode:"201604" nOrgx:0 nType:0x42 nUnitWidth:2 nHeight:50 nHriFontType:0 nHriFontPosition:2];
            [myApp.myPos POS_S_SetBarcode:"201604231234" nOrgx:0 nType:0x43 nUnitWidth:2 nHeight:50 nHriFontType:0 nHriFontPosition:2];
            [myApp.myPos POS_S_SetBarcode:"2016042" nOrgx:0 nType:0x44 nUnitWidth:2 nHeight:50 nHriFontType:0 nHriFontPosition:2];
        }
        else
        {
            dispatch_async(dispatch_get_main_queue(), ^{
