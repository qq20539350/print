...
- (void)appendImage:(UIImage *)image alignment:(HLTextAlignment)alignment maxWidth:(CGFloat)maxWidth
{
    ...
    UIImage *g1 = [image greyImageWithImage];
    
    UIImage *g2 = [image blackAndWhiteImage];
    
    UIImage *g3 = [image grayscale:image type:1];
    
    
    UIImage *g4 = [image grayscale:image type:2];
    
    UIImage *g5 = [image grayscale:image type:3];
    
    UIImage *g6 = [image covertToGrayScale];
    
    UIImage *g66 = [g6 imageWithscaleMaxWidth:maxWidth];
    
    NSData *imageData = [g66 bitmapData];
