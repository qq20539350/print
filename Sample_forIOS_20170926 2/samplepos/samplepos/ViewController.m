...
//    [myApp.myPos POS_PrintQRcode:"电子" x:-3 nUnitWidth:6 nVersion:0 nECCLevel:4];
    ...
    UIImage * img1 = [UIImage imageNamed:@"11.png"];
    [myApp.myPos POS_PrintPicture:img1 x:-1 nWidth:384 nHeight:558 nBinaryAlgorithm:1 nCompressMethod:1];
...
//    [myApp.myPos POS_PrintPicture:img x:-2 nWidth:384 nHeight:614 nBinaryAlgorithm:1 nCompressMethod:0];
//    [myApp.myPos POS_PrintPicture:img x:-2 nWidth:614 nHeight:384 nBinaryAlgorithm:1 nCompressMethod:0];
